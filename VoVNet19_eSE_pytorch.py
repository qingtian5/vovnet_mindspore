...
if __name__ == "__main__":
    model = VoVNet(VoVNet19_dw_eSE, input_ch=3, out_features=["stage2", "stage3", "stage4", "stage5"])
    model.eval()
    input = torch.randn(3, 3, 224, 224)
    output = model(input)
    print('stage2:',output['stage2'].shape,
          'stage3:',output['stage3'].shape,
          'stage4:',output['stage4'].shape,
          'stage5:',output['stage5'].shape)
